...
return [
    ...
    | versiones, como las reglas de tamaño.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes traducir los nombres de los campos de tu base de datos para
    | que las alertas se lean naturales (ej. "El campo fecha de la cita es obligatorio")
    |
    */
